...
Astro also come with a Sitemap and RSS feed generators. A Sitemap is an XML file that outlines all of the pages, videos, and files on your site. Search engines like Google read this file to crawl your site more efficiently. With a custom filter function, you can filter out pages that should not included in the sitemap.xml file.
